...
export const mockWorkers: WorkerProfile[] = [
  {
    ...
    primarySkills: ['Masonry', 'Plumbing'],
    secondarySkills: 'Tiling, waterproofing',
    desiredDailyWage: 800,
    language: 'hi',
    avatarUrl: 'https://picsum.photos/seed/w1/200/200',
  },
  {
    id: 'w2',
    name: 'Suresh Singh',
    ...
    language: 'en',
    avatarUrl: 'https://picsum.photos/seed/w2/200/200',
  },
  {
    id: 'w3',
    name: 'Amit Patel',
    ...
    location: 'Delhi, India',
    primarySkills: ['Electrical', 'General Labour'],
    secondarySkills: 'Appliance installation',
    desiredDailyWage: 700,
    language: 'en',
    avatarUrl: 'https://picsum.photos/seed/w3/200/200',
  },
  {
    id: 'w4',
    name: 'Bikash Das',
